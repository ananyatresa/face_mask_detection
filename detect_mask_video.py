    ...
    while True:
        ...
        for (box, pred) in zip(locs, preds):
            ...
            if mask < withoutMask:
                ...
                FaceFileName = r"C:\Users\tauru\OneDrive\Desktop\project\face_mask_detector\face-store\face_" + str(startY) + ".jpg"
...
lbl_greeting = tk.Label(text=" Welcome to Face Mask Detection \n Press Start to begin", fg="purple1", bg="white")
